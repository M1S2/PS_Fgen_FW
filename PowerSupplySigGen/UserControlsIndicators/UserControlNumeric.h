...
class UserControlNumeric : public UserControlBase
{
    ...
    public:
        UserControlNumeric(uint8_t locx, uint8_t locy, T* controlValue, const char* baseUnit, int8_t valueStoreUnitPower, T minValue, T maxValue, void* valueChangedContext, void (*onValueChanged)(void*), const u8g_pgm_uint8_t* iconBits = NULL);        
