...
void UserControlEnum<T>::KeyInput(Keys_t key)
{
	if(this->IsSelected && this->IsActive)
	{
		...
		else if(key == KEY0 && _numEnumValues > 0) { *value = 0; OnValueChanged(); Device.DevSettingsNeedSaving = true; }
		else if(key == KEY1 && _numEnumValues > 1) { *value = 1; OnValueChanged(); Device.DevSettingsNeedSaving = true; }
		else if(key == KEY2 && _numEnumValues > 2) { *value = 2; OnValueChanged(); Device.DevSettingsNeedSaving = true; }
		else if(key == KEY3 && _numEnumValues > 3) { *value = 3; OnValueChanged(); Device.DevSettingsNeedSaving = true; }
		else if(key == KEY4 && _numEnumValues > 4) { *value = 4; OnValueChanged(); Device.DevSettingsNeedSaving = true; }
		else if(key == KEY5 && _numEnumValues > 5) { *value = 5; OnValueChanged(); Device.DevSettingsNeedSaving = true; }
		else if(key == KEY6 && _numEnumValues > 6) { *value = 6; OnValueChanged(); Device.DevSettingsNeedSaving = true; }
		else if(key == KEY7 && _numEnumValues > 7) { *value = 7; OnValueChanged(); Device.DevSettingsNeedSaving = true; }
		else if(key == KEY8 && _numEnumValues > 8) { *value = 8; OnValueChanged(); Device.DevSettingsNeedSaving = true; }
		else if(key == KEY9 && _numEnumValues > 9) { *value = 9; OnValueChanged(); Device.DevSettingsNeedSaving = true; }
	}
}
