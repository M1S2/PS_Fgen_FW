...
class NumericControl : public NumericIndicator<T>
{
	...
	public:
		...
		NumericControl(unsigned char locX, unsigned char locY, unsigned char width, unsigned char height, T* valuePointer, const char* baseUnit, T minValue, T maxValue, int numFractionalDigits);
